 ...
 */
public class HourWeekAdapter extends RecyclerView.Adapter<HourWeekAdapter.ContactViewHolder> {

    private List<PlaceInfo> placeInfos;

    public HourWeekAdapter(List<PlaceInfo> placeInfos) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.item_day_hour, viewGroup, false);
